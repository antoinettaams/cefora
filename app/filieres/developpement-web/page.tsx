...
export default function Hero() {
  // Données de la section de planning
  const scheduleData = [
    ...
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col-reverse md:flex-row items-center justify-center gap-6 md:gap-10">
          ...
          <div className="text-white w-full md:w-1/2 max-w-2xl text-center md:text-left px-2 sm:px-0">
            ...
            <div className="relative mt-2 md:mt-3">
              <span className="font-title text-2xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-5xl font-bold tracking-tight block">
                Développement Web
              </span>
            </div>
            <p className="text-base md:text-lg text-gray-300 mt-3 md:mt-4 max-w-md mx-auto md:mx-0">
              Apprenez à créer des sites web modernes et des applications interactives. Cette filière couvre HTML, CSS, JavaScript, React, Node.js et la gestion de bases de données.
            </p>
          </div>
      ...
      <section className="bg-white py-20 text-center overflow-x-hidden">
        ...
        <p className="text-gray-500 max-w-xl mx-auto mb-12">
          Maîtrisez les compétences essentielles pour devenir développeur web : du front-end au back-end, création d&apos;applications réactives et gestion de projets web.
        </p>
        ...
        <div className="flex flex-col items-center gap-6 scale-[0.8] sm:scale-[0.9] md:scale-100 transition-transform duration-300">
          <div className="flex justify-center gap-6">
            {[
              { color: "#FDBA21", text: "HTML &amp; CSS", textColor: "#0F172A" },
              { color: "#F43F3E", text: "JavaScript &amp; React", textColor: "#fff" },
              { color: "#1E3AFF", text: "Node.js &amp; Bases de données", textColor: "#fff" },
            ].map((item, index) => (
          ...
          <div className="flex justify-center gap-20">
            {[
              { color: "#FDBA21", text: "Création de portfolio", textColor: "#0F172A" },
              { color: "#FDBA21", text: "Déploiement web", textColor: "#0F172A" },
            ].map((item, index) => (
              <div key={index} className="flex items-center gap-2 px-6 py-3 rounded-full font-medium whitespace-nowrap shadow-sm"
                   style={{ backgroundColor: item.color, color: item.textColor }}>
                <span className="w-2 h-2 bg-white rounded-full"></span>
          ...
          <div className="flex justify-center gap-6">
            {[
              { color: "#F43F3E", text: "Bonnes pratiques", textColor: "#fff" },
              { color: "#1E3AFF", text: "Versioning Git", textColor: "#fff" },
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-12 max-w-7xl mx-auto">
        ...
        <div className="md:w-1/2 w-full space-y-5 md:space-y-6 text-center md:text-left">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#0F172A] leading-tight">
            ...
            <span className="text-[#0F172A]">Développement Web</span>
          </h2>

          <p className="text-gray-500 leading-relaxed max-w-md mx-auto md:mx-0 text-base md:text-lg">
            Cette filière vous prépare à devenir développeur web complet : conception de sites, applications réactives, maîtrise des outils front-end et back-end, et déploiement en conditions réelles.
          </p>
        ...
        {/* Image principale avec cercle derrière */}
